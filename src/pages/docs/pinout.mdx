...
## GaggiMate Standard Rev 2.0 (current)
...
## GaggiMate Alba Tank Light

<Image src={imgPinoutAlba} width={1400} alt="GaggiMate Alba Pinout" />
...
## GaggiMate Pro Rev 1.0 (2025 version)
